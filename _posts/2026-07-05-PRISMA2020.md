...
The flow diagram visually summarizes the study selection process.

It typically contains four stages:

1. **Identification** – Records identified through database searching and other sources.
2. **Screening** – Duplicate records removed and titles/abstracts screened.
3. **Eligibility** – Full-text articles assessed against the inclusion and exclusion criteria.
4. **Included** – Final studies included in the systematic review.

The flow diagram helps readers quickly understand how the final set of studies was obtained.

### 3. Supporting Documents

Depending on the review, researchers may also provide supplementary materials such as:
...
These materials improve transparency and reproducibility.

## Is PRISMA Enough?

PRISMA provides an excellent framework for reporting systematic reviews, but it is only one part of the review process.
...
If you are new to systematic literature reviews, learning PRISMA 2020 is an excellent starting point. It has become the reporting standard adopted by thousands of journals across medicine, computer science, engineering, education, psychology, and many other disciplines.
...
2. Page, M. J., McKenzie, J. E., Bossuyt, P. M., *et al.* (2021). **PRISMA 2020 Explanation and Elaboration: Updated Guidance and Exemplars for Reporting Systematic Reviews.** *BMJ*, 372:n160.
